        ...
        <div class="card">
          ...
          <div v-if="Read == 1" class="card-body">
            ...
            >
              ...
              />
              <table-column  v-if="Write == 1 || Delete == 1"
                :sortable="false"
                :filterable="false"
                label="Actions"
              >
                <template slot-scope="row">
                  <div class="table__actions">
                    ...
                    <router-link v-if="Write == 1" :to="{ name: 'userPrescription', params: { userId: row.id }}"><a v-b-popover.hover ="'User Prescriptions'"
                                                                                                                    class="btn btn-default btn-sm">
                      <i class="icon-fa icon-fa-file-powerpoint-o"/>
                    </a>
                    </router-link>

                    <router-link v-if="Write == 1" :to="{ name: 'edituser', params: { userId: row.id }}"><a v-b-popover.hover ="'EDIT'"
                                                                                                            class="btn btn-default btn-sm">
